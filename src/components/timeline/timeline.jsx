...
import { schedule, dateMap, topArrow, bottomArrow, clockIcon, reloadIcon, timelineDot, dottedLine } from '@/components/timeline/index';
...
const Timeline = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#EFE7F7] px-4 py-8 relative">
      ...
      <div className="rounded-[2rem] border-[2px] border-black bg-[#D3AEFF] w-[calc(100vw-4rem)] max-w-[960px] px-[clamp(1rem,4vw,2.44rem)] pt-[clamp(2rem,3.51rem,5vw)] pb-[clamp(2rem,3.51rem,5vw)]">
