...
const RotatingDollarBagIcon = () => {
  ...
  useEffect(() => {
    const handleScrollBag = () => {
      ...
      if (scrollY < minScroll) {
        ...
        if (dollarBagRef.current) {
          dollarBagRef.current.style.transform = `rotate(${1 * rotation}deg) `;
        }
      }
    };
  ...
  return (
    <div
      ref={dollarBagRef}
      className="overflow-hidden absolute top-[750px] left-[-20px] w-[100px] h-[100px]lg:absolute lg:top-[950px] lg:left-[-50px] lg:w-[200.7941px] lg:h-[200.7941px] z-1   "
    >
      <Image
        width={96}
        height={96}
