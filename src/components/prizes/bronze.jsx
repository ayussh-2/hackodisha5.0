...
function Bronze() {
  return (
    <div className="bg-[#D3AEFF] rounded-2xl p-5 flex relative flex-col items-center justify-center overflow-visible">
              <div className="absolute top-72 -right-9 w-55 rotate-[1deg] z-10">
      <Image
      ...
      />
      <div className="absolute inset-0 flex items-center -left-15 -top-8 justify-center rotate-[-12deg] px-2">
      ...
      <div className="relative bg-[#CD7F32] rounded-full shadow-md flex items-center justify-center px-8 py-5 min-w-[240px] min-h-[70px] overflow-visible">
        ...
        <span className="relative z-10 font-extrabold text-3xl text-black tracking-wider">
          BRONZE
                ...
                {/* Prize Description */}
                <div className="text-center text-purple-800 font-extrabold text-2xl leading-relaxed">
                  Goodies & T-shirts <br />
