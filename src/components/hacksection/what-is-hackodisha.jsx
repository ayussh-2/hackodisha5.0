        ...
        >
            <div className="bg-[#FAF5FF] w-full border-2 max-w-7xl border-black rounded-[3rem] md:rounded-[6rem] px-4 sm:px-8 lg:px-16 xl:px-24 py-6 sm:py-8 lg:py-12 relative">
                ...
                <div className="flex flex-col items-center justify-center gap-8 md:gap-16 max-w-7xl px-8">
                    <ul className="flex p-4 gap-[1.2vw] sm:gap-[1.5vw] md:gap-[2vw]">
                    ...
                    <div className="max-w-full -2 rounded-3xl p-2 h-[90px] sm:h-[141px] bg-#FFF w-[88%] sm:w-[65%] lg:w-[83%] hack-shadow">
                    ...
                    <ul className="flex flex-col max-w-[1100px] p-4 w-[80vw] z-10 top-[52%] lg:top-[41%] absolute justify-between items-start h-[162px] sm:h-[244px] md:h-[280px] lg:h-[471px]">
                    ...
                    />
                    <div className="h-[162px] leading-[1.2rem] sm:leading-normal sm:h-[210px] md:h-[288px] lg:h-[471px] w-[70vw]">
