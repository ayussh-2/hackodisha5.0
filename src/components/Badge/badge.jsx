...
const Badge = () => {
  ...
  const handleDownload = () => {
    ...
    toPng(node, {
      ...
      .catch((err) => {
        ...
        alert("Sorry, the badge could not be downloaded.");
      });
  };
  ...
  return (
    <>
          ...
          <div className="relative w-full max-w-lg rounded-3xl border-4 border-solid border-black bg-[#d3aeff] p-6 shadow-[5px_5px_0px_#000000,1px_1px_0px_#000000,2px_2px_0px_#000000,3px_3px_0px_#000000,4px_4px_0px_#000000]">
            ...
            <div className="mt-4 flex flex-col gap-4 sm:flex-row">
              <button
                ...
                className="flex w-full transform items-center justify-center gap-2 rounded-lg border-2 border-solid border-black bg-[#f0e4ff] py-3 font-['Archivo',_Helvetica] text-xl font-medium text-black transition-transform duration-200 ease-in-out hover:scale-105"
              >
                Cancel
              </button>
              <button
                onClick={handleCropImage}
                className="flex w-full transform items-center justify-center gap-2 rounded-lg border-2 border-solid border-black bg-[#fede64] py-3 font-['Archivo',_Helvetica] text-xl font-bold text-black transition-transform duration-200 ease-in-out hover:scale-105"
              >
                Crop Image
              </button>
            </div>
          ...
          <div className="relative w-full max-w-md rounded-3xl border-2 border-solid border-black bg-white p-6 ">
            ...
            >
              <p className="font-['Archivo',_Helvetica] text-base font-medium text-black">
                <span className="font-bold">Important:</span> Make sure to
                download your badge first! You'll need to attach it manually.
              </p>
            </div>
      ...
      <div className="min-h-screen bg-[#bc82fe] p-4 sm:p-6">
        <main className="mx-auto flex flex-col items-center justify-center gap-8 lg:flex-row lg:items-stretch">
          <div
            ref={badgeRef}
            className="flex w-full max-w-xl flex-col rounded-3xl border-4 border-solid border-black bg-white p-2 shadow-[5px_5px_0px_#000000,1px_1px_0px_#000000,2px_2px_0px_#000000,3px_3px_0px_#000000,4px_4px_0px_#000000] sm:p-4"
          >
            <div className="flex flex-grow flex-col items-end gap-4">
              ...
              <div className="mt-auto flex w-full flex-col gap-4 rounded-3xl border-2 border-solid border-black bg-white p-2">
                <div className="flex items-center gap-2 sm:gap-4">
                  <div className="flex flex-shrink-0 flex-col items-center rounded-2xl border border-solid border-black bg-[#902fff] p-1 sm:p-2">
                    <Image
                      height={64}
                      width={64}
          ...
          <div className="relative flex w-full max-w-xl flex-col rounded-3xl border-4 border-solid border-black bg-[#d3aeff] p-6 pt-8 shadow-[5px_5px_0px_#000000,1px_1px_0px_#000000,2px_2px_0px_#000000,3px_3px_0px_#000000,4px_4px_0px_#000000] sm:p-10 sm:pb-4 sm:pt-12">
            <div className="flex h-full flex-grow flex-col justify-between gap-6">
              <div className="flex flex-col gap-6">
                ...
                >
                  <Image width={32} height={32} alt="Upload" src={upload} />
              ...
              <div className="flex flex-col gap-4 sm:flex-row">
                <button
                  ...
                  className="flex w-full transform items-center justify-center gap-2 rounded-lg border-2 border-solid border-black bg-[#f0e4ff] py-2 transition-transform duration-200 ease-in-out hover:scale-105"
                >
                  <Image width={28} height={28} alt="Download" src={download} />
                ...
                <button
                  ...
                  className="flex w-full transform items-center justify-center gap-2 rounded-lg border-2 border-solid border-black bg-[#fede64] py-2 transition-transform duration-200 ease-in-out hover:scale-105"
                >
                  <Image width={28} height={28} alt="Share" src={share} />
                  <span className="font-['Archivo',_Helvetica] text-xl text-black">
                    Share
                  </span>
                </button>
                ...
                <div className="flex flex-col items-center gap-4 text-center">
                  ...
                  <p className="font-['Archivo',_Helvetica] text-base text-[#2e2e2e]">
                    ...
                    <span className="font-semibold">
                      {" "}
                      Whole team needs to share their badges
                    </span>
                    <span className="font-medium"> on social media</span> & tag
                    @webwiz.nitr
                  </p>
                  <p className="font-['Archivo',_Helvetica] text-base text-[#2e2e2e]">
                    Other teams are already grabbing bonus points. Don’t let
                    your team miss out.
                  </p>
                </div>
              </div>
