...
const Page= () => {
  ...
  const sponsors = Array(6).fill('https://res.cloudinary.com/ddycqjdeu/image/upload/v1749813307/solana_njcbvj.svg');

  const SponsorGroup = ({ title, sponsors }) => (
    <div className="overflow-hidden p-[10px]  lg:ml-[100px] lg:mr-[100px]">
      <div className="fit  pl-[25px] w-[300px] h-[60px] text-centre text-wrap flex flex-col justify-center lg:pl-[300px] lg:w-[500px] lg:h-[100px]">
          <span className="text-[17px] px-4 py-2 lg:px-8 lg:py-4 bg-[#FFEA89] rounded-3xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1.00)]   outline-1 outline-offset-[-1px] outline-black inline-flex justify-center items-center gap-2  --font-archivo lg:font-weight-[700] lg:text-[36px] lg:shadow-[6px_6px_0px_0px_rgba(0,0,0,1.00)] ">
    ...
    <div className="bg-[#EFE7F7] h-full w-full p-8 relative overflow-hidden">
      ...
      <div className="relative w-[70px] h-[60px]  top-[-1px] left-[130px] mb-[60px] lg:left-[400px] flex justify-center  mt-1 lg:mb-[84px] lg:mt-3  lg:w-[493px] lg:h-32">
        <div className="w-20 h-20 px-2 py-1.5 rounded-md shadow-[2px_2px_0px_0px_rgba(0,0,0,1.00),-2px_-2px_0px_0px_rgba(0,0,0,1.00)]     fit lg:w-[493px] lg:h-32 lg:px-3 lg:py-3.5 relative bg-white lg:rounded-3xl lg:shadow-[3px_4px_0px_0px_rgba(0,0,0,1.00),-3px_-4px_0px_0px_rgba(0,0,0,1.00)]  inline-flex flex-col justify-center items-center gap-2.5">
            <h2 className="border-dotted text-2xl px-1 py-1 border-2 --font-clash-display lg:text-3xl lg:font-bold lg:border-4 border-black lg:border-dotted inline-block lg:px-6 lg:py-2 rounded-xl bg-white">
                SPONSORS
            </h2>
        </div>
      ...
      <SponsorGroup title="Platinum" sponsors={sponsors.slice(0, 6)} />
      <SponsorGroup title="Gold" sponsors={sponsors.slice(0, 6)} />
      <SponsorGroup title="Silver" sponsors={sponsors.slice(0, 6)} />
    </div>
  );
};
