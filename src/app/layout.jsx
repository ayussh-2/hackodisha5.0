  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta property="og:image" content="https://hackodisha.com/Images/logo.png" />
        ...
        />
        <meta name="twitter:image" content="https://hackodisha.com/Images/logo.png" />
      ...
      >
        <Toaster
          ...
          toastOptions={{
            style: {
              background: "#2d1b4e", // Matches violet theme (bg-violet-800)
              color: "#ffd700", // Matches amber theme (amber-700)
